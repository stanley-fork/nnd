...
impl Default for TypeInfo { fn default() -> Self { Self {name: "", size: 0, die: DebugInfoOffset(0), flags: TypeFlags::empty(), language: LanguageFamily::Internal, t: Type::Unknown} } }
